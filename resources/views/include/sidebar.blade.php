        ...
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item {{ $segment1 == 'member' || $segment1 == 'level' ? 'active open' : '' }} has-sub">
                    <a href="#"><i class="ik ik-users"></i><span>{{ __('Membership') }}</span></a>
                    <div class="submenu-content">
                        <a href="{{ url('level') }}"
                ...
                <div class="nav-item {{ $segment1 == 'rewards' ? 'active open' : '' }} has-sub">
                    <a href="#"><i class="ik ik-gift"></i><span>{{ __('Reward') }}</span></a>
                    <div class="submenu-content">
                ...
                <div
                    ...
                    <div class="submenu-content">
                        <a href="{{ url('message') }}"
                            class="menu-item {{ $segment1 == 'message' ? 'active' : '' }}">{{ __('Messages Notification') }}</a>
                    </div>
                </div>
                ...
                <div class="nav-item {{ $segment1 == 'setting' ? 'active' : '' }}">
                    <a href="{{ route('setting.index') }}"><i class="ik ik-settings"></i><span>{{ __('Setting') }}</span></a>
                </div>
                <div class="nav-item {{ $segment1 == 'slider' ? 'active' : '' }}">
                    <a href="{{ route('slider.index') }}"><i class="ik ik-sliders"></i><span>{{ __('Slider') }}</span></a>
                </div>
                <div class="nav-item {{ $segment1 == 'faq' ? 'active' : '' }}">
                    <a href="{{ route('faq.index') }}"><i class="ik ik-message-circle"></i><span>{{ __('Faq') }}</span></a>
                </div>
