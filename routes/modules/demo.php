...
Route::GET('/level', [LevelMembershipController::class, 'index'])->name('getMembership');
Route::POST('membership/create', [LevelMembershipController::class, 'create'])->name('addMembership');
Route::POST('membership/edit', [LevelMembershipController::class, 'edit'])->name('editMembership');
Route::POST('membership/delete', [LevelMembershipController::class, 'delete'])->name('deleteMembership');

Route::GET('/message', [MessageController::class, 'index'])->name('getMessage');
Route::GET('message/get', [MessageController::class, 'getOption'])->name('getOptionCategory');
Route::POST('message/create', [MessageController::class, 'create'])->name('addMessage');
Route::POST('message/edit', [MessageController::class, 'edit'])->name('editMessage');
Route::POST('message/delete', [MessageController::class, 'delete'])->name('deleteMessage');
